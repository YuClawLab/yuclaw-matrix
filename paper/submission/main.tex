...
The Chinese Remainder Theorem originates from Sun Zi's \emph{Suanjing} (S\={u}n Z\v{i} Su\`{a}nj\={\i}ng), dated to approximately 279~CE. Problem~26 asks for a number with given remainders when divided by 3, 5, and 7. The theorem was later formalized by Gauss in \emph{Disquisitiones Arithmeticae} (1801, \S36).
...
\bibitem{sunzi} Sun Zi, \emph{Sun Zi Suanjing} (S\={u}n Z\v{i} Su\`{a}nj\={\i}ng), c.\ 279 CE, Problem 26.
